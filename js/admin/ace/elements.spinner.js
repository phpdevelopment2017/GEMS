...
(function($ , undefined) {
	...
	function Ace_Spinner(element , _options) {
		...
		var options = $.extend({}, $.fn.ace_spinner.defaults, _options);
		...
		// Added by Chitrang Shah to fix the width
		if(options.width){
			width = options.width;
		}
